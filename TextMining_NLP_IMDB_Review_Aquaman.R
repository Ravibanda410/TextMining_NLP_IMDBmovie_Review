...
setwd("C:/RAVI/Data science/Assignments/Text Mining-Natural Language Processing(NLP)/IMDB_Aquaman")
...
# the terms indicate that there are 11236 words and 385832 documents(# of tweets) in this TDM
...
# the word Aquaman,Like and Just as the highest frequency. This implies
# that Movie Aquaman has got more reviews about the aquaman and 
...
# on tweet 4, you have 5 for anger, 3 for disgust, 3 for fear 
# and 3 for sadness, 3 for trust , 7 words for negative and 3 positive.
